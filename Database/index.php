...
if (isset($_POST["add"])) {
    if (isset($_SESSION["shopping_cart"])) {
        ...
        if (!in_array($_GET["id"], $item_array_id)) {
            ...
            echo '<script>alert("Game Sudah ada di Keranjang")</script>';
            echo '<script>window.location="index.php"</script>';
        }
    } else {
        $item_array = array(
    ...
    if ($_GET["action"] == "delete") {
        foreach ($_SESSION["shopping_cart"] as $keys => $value) {
            if ($value["product_id"] == $_GET["id"]) {
                ...
                echo '<script>alert("Game berhasil dihilangkan dari keranjang")</script>';
                echo '<script>window.location="index.php"</script>';
            }
        }
    }
...
<body>
    <div class="container" style="width: 65%">
        ...
        <h2 style="text-transform: uppercase;">Game Shopping Cart</h2>
        ...
        <div class="col-md-3" style="float: left;">
            <form method="post" action="index.php?action=add&id=<?php echo $row["id"]; ?>">
                <div class="product">
                    ...
                    <h6 class="text-danger">RP <?php echo $row["price"]; ?>.00</h6>
        ...
        <div class="table-responsive">
            <table class="table table-bordered" style="font-family: monospace;">
                <tr>
                    <th width="30%">Deskripsi Produk</th>
            ...
            <?php
                ...
                $url = "../tampilanawal/index.html";
        ?>
            
        </div>
        <a href="<?php echo $url; ?>" class="button">Beranda</a>
    </div>
